...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'detect_traffic_light2 = turtlebot3_autorace_detect.detect_traffic_light2:main',
            'detect_tl_line = turtlebot3_autorace_detect.detect_tl_line:main',
            'test = turtlebot3_autorace_detect.test_node:main',
            'detect_level_crossing2 = turtlebot3_autorace_detect.detect_level_crossing2:main',
            'save_img = turtlebot3_autorace_detect.save_img:main',
            'detect_signs_yolo = turtlebot3_autorace_detect.detect_signs_yolo:main',
        ],
    },
)
